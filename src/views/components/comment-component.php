   ...
   <div class="width-100">
      ...
      <div class="comment__votes">
         <span class="comment__vote" data-vote="upvote">
            <i data-markedvote="<?php if ($comment->vote_user_id == $userLoggedId && $comment->vote_type_id == 1) : echo "marked";
                                 else : echo "none";
         ...
         <span class="comment__vote" data-vote="downvote">
            <i data-markedvote="<?php if ($comment->vote_user_id == $userLoggedId && $comment->vote_type_id == 2) : echo "marked";
                                 else : echo "none";
      ...
      <div class="<?php if ($comment->comment_user_id == $userLoggedId) : echo "width-70";
                  else : echo "width-80";
                  endif; ?>">
         <p class="comment__description"><?= $comment->description ?></p>
      </div>

      <?php if ($comment->comment_user_id == $userLoggedId) : ?>
