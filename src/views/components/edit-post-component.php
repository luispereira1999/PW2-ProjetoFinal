<!-- DEFINIÇÃO: popup de edit um post -->
   ...
   <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form class="popup__form" id="formEditPost" method="post" action="/post/edit/<?= $posts[$current]->post_id; ?>">
         ...
         <div class="modal-footer">
            <button class="button button-primary" type="submit" form="formEditPost" name="isEdit">Editar</button>
