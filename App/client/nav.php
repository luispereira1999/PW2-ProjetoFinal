...
if (isset($_SESSION["login"]) || isset($_COOKIE["login"])) : ?>
   ...
   <nav class="navigationBar">
      ...
      <div class="navCenter">
         <a href="../client/index.php"><img src="../server/assets/images/logo.png" class="logo"></a>
      </div>
      <div class="navRight">
         ...
         <div class="dropdown">
            ...
            <div class="contentDropdown">
               ...
               <a href="setting.php"><i class="dropdownIcons fas fa-user-edit"></i>Editar Utilizador</a>
...
<?php else : ?>
   ...
   <nav class="navigationBar">
      ...
      <div class="navCenter">
         <a href="index.php"><img src="../server/assets/images/logo.png" class="logo"></a>
      </div>
      <div class="navRight">
         <a href="login-signup.php" data-toggle="tooltip" data-placement="bottom" title="Login / Signup"><i class="navigationIcons fas fa-user-plus"></i></a>
         <div class="dropdown">
            <button class="buttonDropdown"><i class="navigationIcons fas fa-ellipsis-v"></i></button>
            <div class="contentDropdown">
